...
module uart_top (
    ...
    wire w_tx_in = (~w_rx_fifo_empty) | w_sender_start;
    wire [7:0] w_tx_in_data = (w_sender_start) ? w_sender_data : w_rx_fifo_pop_data;
    ...
    ascii_sender U_ASCII_SENDER (
        ...
        .tx_busy (w_tx_busy),
        .tx_done (w_tx_done),
        .tx_start(w_sender_start),
        .tx_data (w_sender_data)
    );
