...
HD_PWD='D:/choiyeoji/20260129_fsm_1/20260129_fsm_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsm_1.tcl
