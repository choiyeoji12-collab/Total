...
HD_PWD='D:/choiyeoji/20260129_fsm_1/20260129_fsm_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_1.tcl -notrace
