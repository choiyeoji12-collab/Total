...
HD_PWD='D:/choiyeoji/project_spi_master/project_spi_master.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_master.tcl
