...
HD_PWD='D:/choiyeoji/project_spi_master/project_spi_master.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_master.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_master.tcl -notrace
