...
HD_PWD='D:/choiyeoji/sensor2_uart_fifo_stopwatch_watch/sensor2_uart_fifo_stopwatch_watch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sensor2_uart_fifo_stopwatch_watch.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_sensor2_uart_fifo_stopwatch_watch.tcl
