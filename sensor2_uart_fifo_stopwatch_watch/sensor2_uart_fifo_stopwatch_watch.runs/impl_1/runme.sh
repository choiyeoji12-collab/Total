...
HD_PWD='D:/choiyeoji/sensor2_uart_fifo_stopwatch_watch/sensor2_uart_fifo_stopwatch_watch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_sensor2_uart_fifo_stopwatch_watch.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_sensor2_uart_fifo_stopwatch_watch.tcl -notrace
