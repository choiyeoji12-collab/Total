...
module fnd_controller (
    input         clk,
    input         reset,
    input         sel_display,       // HH:MM, SS:MS display
    input         display_mode,      // watch,stopwatch / number 
    input  [15:0] display_bcd_data,  // number display (1000,100,10,1)
    ...
    wire [3:0] watch_1 = (sel_display) ? w_digit_min_1 : w_digit_msec_1;
    wire [3:0] watch_10 = (sel_display) ? w_digit_min_10 : w_digit_msec_10;
    wire [3:0] watch_100 = (sel_display) ? w_digit_hour_1 : w_digit_sec_1;
    wire [3:0] watch_1000 = (sel_display) ? w_digit_hour_10 : w_digit_sec_10;

    assign digit_1    = (display_mode) ? display_bcd_data[3:0] : watch_1;
    assign digit_10   = (display_mode) ? display_bcd_data[7:4] : watch_10;
    assign digit_100  = (display_mode) ? display_bcd_data[11:8] : watch_100;
    assign digit_1000 = (display_mode) ? display_bcd_data[15:12] : watch_1000;
