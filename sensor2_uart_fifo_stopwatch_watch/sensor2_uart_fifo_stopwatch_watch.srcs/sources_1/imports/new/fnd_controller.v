...
module fnd_controller (
    ...
    assign w_dot_use = (display_mode) ? 1'b0 : w_dot_onoff;
    ...
    wire [3:0] time_1 = (sel_display) ? w_digit_min_1 : w_digit_msec_1;
    wire [3:0] time_10 = (sel_display) ? w_digit_min_10 : w_digit_msec_10;
    wire [3:0] time_100 = (sel_display) ? w_digit_hour_1 : w_digit_sec_1;
    wire [3:0] time_1000 = (sel_display) ? w_digit_hour_10 : w_digit_sec_10;

    assign digit_1    = (display_mode) ? display_bcd_data[3:0]   : time_1;
    assign digit_10   = (display_mode) ? display_bcd_data[7:4]   : time_10;
    assign digit_100  = (display_mode) ? display_bcd_data[11:8]  : time_100;
    assign digit_1000 = (display_mode) ? display_bcd_data[15:12] : time_1000;
    ...
    mux_8x1 U_Mux_HOUR_MIN (
        ...
        .digit_dot_1   (4'hf),
        .digit_dot_10  (4'hf),
        .digit_dot_100 ({3'b111, w_dot_use}),
        .digit_dot_1000(4'hf),
        .mux_out       (w_mux_out)
    );
