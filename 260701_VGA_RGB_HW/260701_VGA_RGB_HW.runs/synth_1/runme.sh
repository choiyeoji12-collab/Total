...
HD_PWD='D:/choiyeoji/260701_VGA_RGB_HW/260701_VGA_RGB_HW.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_SW_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_SW_top.tcl
