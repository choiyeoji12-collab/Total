...
HD_PWD='D:/choiyeoji/260701_VGA_SW_RGB/260701_VGA_SW_RGB.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_SW_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_SW_top.tcl -notrace
